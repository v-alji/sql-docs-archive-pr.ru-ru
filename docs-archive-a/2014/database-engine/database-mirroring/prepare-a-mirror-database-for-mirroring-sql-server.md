...
-   Нельзя создать зеркальную копию базы данных, которая принадлежит [группы доступности AlwaysOn (SQL Server)](../availability-groups/windows/always-on-availability-groups-sql-server.md).  
