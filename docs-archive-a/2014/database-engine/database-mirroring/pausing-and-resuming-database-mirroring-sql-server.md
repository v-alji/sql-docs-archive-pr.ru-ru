...
##  <a name="how-pausing-and-resuming-affect-log-truncation"></a><a name="EffectOnLogTrunc"></a> Влияние приостановки и возобновления на усечение журнала  
...
##  <a name="avoid-a-full-transaction-log"></a><a name="AvoidFullLog"></a> Избежание переполнения журнала транзакций  
