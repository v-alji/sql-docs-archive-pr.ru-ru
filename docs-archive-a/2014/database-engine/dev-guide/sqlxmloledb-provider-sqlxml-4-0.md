...
## <a name="in-this-section"></a>в этом разделе  
 [Введение в поставщик SQLXMLOLEDB &#40;SQLXML 4,0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/data-access-components-provider/introduction-to-the-sqlxmloledb-provider-sqlxml-4-0.md)  
 Содержит основные сведения о поставщике SQLXMLOLEDB и перечисляет свойства, зависящие от SQLXMLOLEDB.  
