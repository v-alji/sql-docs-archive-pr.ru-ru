...
-   [Ошибки и события поставщика WMI](../../relational-databases/native-client-ole-db-errors/errors.md)  
  
-   [Поставщик WMI для классов управления конфигурацией](../../relational-databases/wmi-provider-configuration-classes/wmi-provider-for-configuration-management-classes.md)  
