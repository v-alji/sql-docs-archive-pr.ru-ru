...
3.  В каталоге c:\MySample создайте файл `ComplexNumber.vb` (для образца на языке Visual Basic) или `ComplexNumber.cs` (для образца на языке C#) и скопируйте в него соответствующий образец кода на языке Visual Basic или C#, приведенный ниже.  
...
6.  Скопируйте код установки [!INCLUDE[tsql](../../includes/tsql-md.md)] в файл и сохраните его в файле `Install.sql` в том же каталоге.  
  
7.  Если образец установлен в каталоге, отличном от `C:\MySample\`, внесите изменения в файл `Install.sql` , указав там этот каталог.  
  
8.  Разверните сборку и хранимую процедуру, выполнив  
...
11. Запуск примера клиентской программы (только C#).  
  
    -   В каталоге c:\MySample создайте файл `Program.cs` и скопируйте в него исходный код.  
    ...
    -   Тест, выполнив:`Client AdventureWorks`  
