 ...
 **Тип сервера**  
 При регистрации сервера из списка «Зарегистрированные серверы» поле **Тип сервера** доступно только для чтения и соответствует типу сервера, отображаемому на панели « **Зарегистрированные серверы** ». Чтобы зарегистрировать другой тип сервера, щелкните нужный сервер на панели инструментов **Зарегистрированные серверы** , прежде чем регистрировать новый сервер.  
