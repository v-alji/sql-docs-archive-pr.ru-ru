...
##  <a name="database-engine-feature-enhancements"></a><a name="Feature"></a>Усовершенствованные функции ядро СУБД  
  
###  <a name="memory-optimized-tables"></a><a name="MemoryOpt"></a>Оптимизированные для памяти таблицы  
...
###  <a name="sql-server-data-files-in-azure"></a><a name="DataFiles"></a>SQL Server файлы данных в Azure  
...
###  <a name="host-a-sql-server-database-in-an-azure-virtual-machine"></a><a name="AzureVM"></a>Размещение базы данных SQL Server на виртуальной машине Azure  
...
###  <a name="backup-and-restore-enhancements"></a><a name="Backup"></a>Усовершенствования резервного копирования и восстановления  
...
###  <a name="new-design-for-cardinality-estimation"></a><a name="CE"></a>Новый дизайн для оценки количества элементов  
...
###  <a name="delayed-durability"></a><a name="Durability"></a>Отложенная устойчивость  
...
###  <a name="alwayson-enhancements"></a><a name="AlwaysOn"></a>Усовершенствования AlwaysOn  
...
###  <a name="partition-switching-and-indexing"></a><a name="OIR"></a>Переключение секций и индексирование  
...
###  <a name="managing-the-lock-priority-of-online-operations"></a><a name="Lock"></a>Управление приоритетом блокировки операций в сети  
...
###  <a name="columnstore-indexes"></a><a name="CCI"></a>Индексы columnstore  
...
###  <a name="buffer-pool-extension"></a><a name="Buffer"></a>Расширение буферного пула  
...
###  <a name="incremental-statistics"></a><a name="Stats"></a>Добавочная статистика  
...
###  <a name="resource-governor-enhancements-for-physical-io-control"></a><a name="RG"></a>Resource Governor улучшений для управления физическими операциями ввода-вывода  
...
###  <a name="online-index-operation-event-class"></a><a name="OnlineEvent"></a>Класс событий Online Index Operation  
...
###  <a name="database-compatibility-level"></a><a name="Compat"></a>Уровень совместимости базы данных  
...
##  <a name="transact-sql-enhancements"></a><a name="TSQL"></a>Улучшения Transact-SQL  
...
### <a name="tsql-enhancements-for-in-memory-oltp"></a>Улучшения [!INCLUDE[tsql](../includes/tsql-md.md)] для In-Memory OLTP  
...
##  <a name="deployment-enhancements"></a><a name="Deployment"></a>Усовершенствования развертывания  
