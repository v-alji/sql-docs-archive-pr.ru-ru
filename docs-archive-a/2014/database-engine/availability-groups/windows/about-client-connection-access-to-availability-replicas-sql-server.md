...
|------------------|--------------------------------------------|-----------------------|--------------------------------|  
|Вторичная|Все|С намерением только чтения, чтения-записи или назначение соединения не указано|Успешно|  
|Вторичная|Нет (поведение по умолчанию вторичной реплики).|С намерением только чтения, чтения-записи или назначение соединения не указано|Сбой|  
|Вторичная|Назначение — только чтение|С намерением чтения|Успешно|  
|Вторичная|Назначение — только чтение|С намерением чтения-записи или назначение соединения не указано|Сбой|  
|Первичный|Все (поведение по умолчанию первичной реплики).|С намерением только чтения, чтения-записи или назначение соединения не указано|Успешно|  
|Первичный|Чтение и запись|Назначение — только чтение|Сбой|  
|Первичный|Чтение и запись|С намерением чтения-записи или назначение соединения не указано|Успешно|  
