...
---
# <a name="sql-server-2014-transaction-log-architecture-and-management"></a>Архитектура журнала транзакций SQL Server 2014 и управление

**Применимо к:** SQL Server (начиная с 2008)
