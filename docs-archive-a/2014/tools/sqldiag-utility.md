 ...
 **/M** _machine1_ [ *machine2 * * мачинен*] |*@machinelistfile*  
 ...
 Используется *@machinelistfile* для указания имени файла списка компьютеров для сохранения в файле конфигурации.  
