...
|[Преобразование "Многоадресная рассылка"](multicast-transformation.md)|Преобразование, распределяющее наборы данных по различным выходам.|  
