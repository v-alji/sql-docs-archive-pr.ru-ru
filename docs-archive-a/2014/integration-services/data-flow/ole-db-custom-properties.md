...
|OpenRowset|Строка|Если AccessMode имеет значение `OpenRowset` , то имя таблицы или представления, к которому обращается целевой объект OLE DB.|  
|OpenRowsetVariable|Строка|Если AccessMode имеет значение `OpenRowset from Variable` , имя переменной, содержащей имя таблицы или представления, к которому обращается целевой объект OLE DB.|  
|SqlCommand|Строка|Если AccessMode имеет значение `SQL Command` , то инструкция Transact-SQL, используемая назначением OLE DB для указания целевых столбцов данных.|  
