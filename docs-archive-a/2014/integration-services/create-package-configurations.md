...
> [!NOTE]  
>  Вы также можете получить доступ к **организатору конфигураций пакетов**, нажав кнопку с многоточием рядом со свойством **конфигурации** . Свойство «Конфигурация» отображается в окне свойств пакета.  
