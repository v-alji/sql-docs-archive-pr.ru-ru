...
## <a name="see-also"></a>См. также:  
 ...
 [Запуск пакета в SQL Server Data Tools](../../2014/integration-services/run-a-package-in-sql-server-data-tools.md)   
