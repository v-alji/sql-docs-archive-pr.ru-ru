...
##  <a name="overview-of-sql-server-high-availability-solutions"></a><a name="TermsAndDefinitions"></a>Обзор SQL Server решений с высоким уровнем доступности  
...
##  <a name="recommended-solutions-for-using-sql-server-to-protect-data"></a><a name="RecommendedSolutions"></a> Рекомендуемые решения для использования SQL Server в целях защиты данных  
