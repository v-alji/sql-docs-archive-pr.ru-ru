...
# <a name="winsock-proxy-configuration-not-supported"></a>Не поддерживается конфигурация прокси-сервера Winsock
  Прокси-сервер Winsock не может быть настроен с помощью [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] средств.  
