...
1.  Переместите файлы модуля в новую программную папку для сервера отчетов. По умолчанию папка программы сервера отчетов находится в папке \Program Files\Microsoft SQL Server \ MSRS10_50. \<*instance_name*> сервер папке \Report.  
