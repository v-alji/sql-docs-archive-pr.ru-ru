...
5.  В списке Тип сервера выберите **Analysis Services**.  
  
6.  В поле имя сервера введите ** \<server-name> \PowerPivot**, где **\<server-name>** — имя компьютера, на котором установлена PowerPivot для SharePoint установка.  
