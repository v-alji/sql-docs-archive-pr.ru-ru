...
2.  Кроме того, вы можете проверить версию файла.  
     ...
     Перейдите по адресу `C:\Program files\Microsoft Analysis Services\AS OLEDB\10`. Щелкните правой кнопкой мыши **msolap100.dll** и выберите пункт **свойства**. Щелкните **Сведения**.  
