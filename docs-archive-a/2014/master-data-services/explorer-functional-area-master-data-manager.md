...
## <a name="data-management"></a>Управление данными  
 ...
 [Изменение типа атрибута (надстройка MDS для Excel)](microsoft-excel-add-in/change-the-attribute-type-mds-add-in-for-excel.md)  
 ...
 [Добавление заметки для транзакции (службы Master Data Services)](../../2014/master-data-services/annotate-a-transaction-master-data-services.md)  
