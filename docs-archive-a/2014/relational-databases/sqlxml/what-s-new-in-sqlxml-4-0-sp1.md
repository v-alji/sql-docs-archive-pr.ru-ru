...
-   [Сопоставление по умолчанию элементов и атрибутов XSD с таблицами и столбцами](../sqlxml-annotated-xsd-schemas-using/default-mapping-of-xsd-elements-and-attributes-to-tables-and-columns-sqlxml-4-0.md)  
