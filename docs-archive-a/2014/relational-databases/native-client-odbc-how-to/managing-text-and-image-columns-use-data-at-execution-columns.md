...
1.  Для каждого столбца с данными времени выполнения поместите специальные значения в буферы, предварительно привязанные к [SQLBindCol](../native-client-odbc-api/sqlbindcol.md):  
...
3.  Для каждого столбца с данными времени выполнения.  
    ...
    -   Вызовите функцию [SQLPutData](../native-client-odbc-api/sqlputdata.md) один или более раз, чтобы отправить данные столбца, до тех пор, пока не будет отправлена длина.  
