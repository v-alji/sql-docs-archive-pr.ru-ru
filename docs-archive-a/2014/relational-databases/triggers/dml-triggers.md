...
|`varchar(max)``nvarchar(max)` `varbinary(max)` ссылки на столбцы, и в таблицах **inserted** и **deleted**|Разрешено|Разрешено|  
|`text``ntext` `image` ссылки на столбцы, и в таблицах **inserted** и **deleted**|Не разрешено|Разрешено|  
