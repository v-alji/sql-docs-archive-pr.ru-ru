...
## <a name="ssnoversion-query-processing-for-disk-based-tables"></a>[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Обработка запросов для дисковых таблиц  
 ...
 ![Канал обработки запросов в SQL Server.](../../database-engine/media/hekaton-query-plan-3.gif "Канал обработки запросов в SQL Server.")  
...
## <a name="interpreted-tsql-access-to-memory-optimized-tables"></a>Доступ к оптимизированным для памяти таблицам с помощью интерпретируемого кода [!INCLUDE[tsql](../../../includes/tsql-md.md)]  
 ...
 ![Канал обработки запросов для интерпретируемых инструкций tsql.](../../database-engine/media/hekaton-query-plan-4.gif "Канал обработки запросов для интерпретируемых инструкций tsql.")  
...
### <a name="compilation-and-query-processing"></a>Компиляция и обработка запросов  
 ...
 ![Компиляция хранимых процедур в собственном коде.](../../database-engine/media/hekaton-query-plan-6.gif "Компиляция хранимых процедур в собственном коде.")  
...
|Сортировка|`SELECT ContactName FROM dbo.Customer`  <br /> `ORDER BY ContactName`|  
