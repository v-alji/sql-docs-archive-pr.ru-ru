...
## <a name="transactions-and-error-handling"></a>Транзакции и обработка ошибок  
 ...
 Все хранимые процедуры, скомпилированные в собственном коде, поддерживают конструкции `TRY`, `CATCH` и `THROW` для обработки ошибок. Тип `RAISERROR` не поддерживается.  
