...
##  <a name="setting-the-service-account"></a><a name="setting"></a>Настройка учетной записи службы  
...
##  <a name="if-the-sql-full-text-filter-daemon-launcher-service-does-not-start"></a><a name="error"></a>Если служба SQL Full-text Filter Daemon Launcher не запускается  
