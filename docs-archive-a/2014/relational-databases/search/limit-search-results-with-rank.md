...
##  <a name="examples-of-using-rank-to-limit-search-results"></a><a name="examples"></a> Примеры использования параметра RANK для ограничения результатов поиска  
...
##  <a name="how-search-query-results-are-ranked"></a><a name="how"></a> Как ранжируются результаты поискового запроса  
