...
##  <a name="view-the-contents-of-a-dac"></a><a name="ViewDACContents"></a> просмотр содержимого приложения уровня данных  
...
##  <a name="compare-dacs"></a><a name="CompareDACs"></a>Сравнить приложений уровня данных  
