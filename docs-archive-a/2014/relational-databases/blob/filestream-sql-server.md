...
##  <a name="when-to-use-filestream"></a><a name="whentouse"></a>Когда следует использовать FILESTREAM  
...
##  <a name="filestream-storage"></a><a name="storage"></a>Хранилище FILESTREAM  
