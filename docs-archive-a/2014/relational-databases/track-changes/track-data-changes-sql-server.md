...
|Признак|система отслеживания измененных данных|Change tracking|  
|-------------|-------------------------|---------------------|  
...
|-|-|  
|**Задача**|**Раздел**|  
|Содержит общие сведения о системе отслеживания измененных данных.|[О фиксации измененных данных (SQL Server)](../track-changes/about-change-data-capture-sql-server.md)|  
