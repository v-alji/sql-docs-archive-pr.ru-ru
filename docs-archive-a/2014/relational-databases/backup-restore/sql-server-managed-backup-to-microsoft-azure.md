...
## <a name="benefits-of-automating-sql-server-backup-using-ss_smartbackup"></a>Преимущества автоматизации резервного копирования SQL Server с помощью [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]  
...
##  <a name="requirements-concepts-and-components"></a><a name="Concepts"></a>Требования, понятия и компоненты  
...
###  <a name="support-limitations"></a>Ограничения поддержки в <a name="support_limits"></a>  
