...
11. По желанию можно использовать страницу **Файлы** для восстановления базы данных в новом расположении. Дополнительные сведения см. в разделе [Восстановление базы данных в новом расположении (SQL Server)](restore-a-database-to-a-new-location-sql-server.md).  
