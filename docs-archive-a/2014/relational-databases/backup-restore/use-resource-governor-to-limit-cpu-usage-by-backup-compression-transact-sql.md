...
1.  Создайте имя входа на [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] для создания низкоприоритетных сжатых резервных копий.  
    ...
    -   [Создание имени входа](../security/authentication-access/create-a-login.md)  
