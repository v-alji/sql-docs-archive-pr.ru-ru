...
2.  Используемых Обратите внимание на количество строк, удаленных на шаге 1 из системных таблиц [MSmerge_genhistory](/sql/relational-databases/system-tables/msmerge-genhistory-transact-sql), [MSmerge_contents](/sql/relational-databases/system-tables/msmerge-contents-transact-sql)и [MSmerge_tombstone](/sql/relational-databases/system-tables/msmerge-tombstone-transact-sql) , возвращаемых соответственно в **@num_genhistory_rows** **@num_contents_rows** **@num_tombstone_rows** выходных параметрах, и.  
