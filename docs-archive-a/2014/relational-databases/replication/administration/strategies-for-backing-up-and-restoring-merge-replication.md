...
### <a name="reinitializing-all-subscriptions"></a>Повторная инициализация всех подписок  
 ...
 Чтобы повторно инициализировать подписку, см. раздел [Reinitialize a Subscription](../reinitialize-a-subscription.md).  
  
 Чтобы создать и применить моментальный снимок, см. разделы [Create и Apply the Initial Snapshot](../create-and-apply-the-initial-snapshot.md) и [Create a Snapshot for a Merge Publication with Parameterized Filters](../create-a-snapshot-for-a-merge-publication-with-parameterized-filters.md).  
