...
3.  Выберите тип подписки для отображения из раскрывающегося списка **Показать подписки \<SubscriptionType>** . Для просмотра только подписок, находящихся в заданном состоянии, например синхронизирующихся, выберите параметр из раскрывающегося списка **Показать** .    
