...
2.  Перейдите в папку моментальных снимков. Расположение по умолчанию — «C:\Program Files\Microsoft SQL Server\MSSQL12. \<INSTANCE> \Мсскл\реплдата\унк\кскскс\ииииммддххммсс \\ ".  
