...
-   Удалить из публикации статью, сняв флажок рядом с этим объектом. Чтобы узнать, какие статьи можно удалять, изучите статью о [добавлении и удалении статей в существующих публикациях](publish/add-articles-to-and-drop-articles-from-existing-publications.md).  
