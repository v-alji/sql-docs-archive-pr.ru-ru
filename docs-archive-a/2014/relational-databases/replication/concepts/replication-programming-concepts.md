...
|[Хранимые процедуры репликации (Transact-SQL)](/sql/relational-databases/system-stored-procedures/replication-stored-procedures-transact-sql)|Написание сценариев|Администрирование и текущее наблюдение.|  
|[Replication Agent Executables Concepts](replication-agent-executables-concepts.md)|Написание сценариев|Синхронизация.|  
