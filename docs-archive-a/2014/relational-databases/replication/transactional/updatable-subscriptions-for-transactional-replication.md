...
В SQL Server 2014 репликация транзакций поддерживает обновления на подписчиках через обновляемые подписки и одноранговую репликацию. Существуют два типа обновляемых подписок:  
