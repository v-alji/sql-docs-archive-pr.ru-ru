...
ms.locfileid: "87750815"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="b4171-102">Поддержка потоков для выходных параметров BLOB</span><span class="sxs-lookup"><span data-stu-id="b4171-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="b4171-103">В этом разделе содержится образец, показывающий поддержку потоков для выходных параметров BLOB, который связывает выходные параметры BLOB как потоки ISequentialStreams.</span><span class="sxs-lookup"><span data-stu-id="b4171-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="b4171-104">Выходные параметры могут быть заблокированы в методе IMultipleResults::GetResult при получении возвращаемого значения DB_E_OBJECTOPEN.</span><span class="sxs-lookup"><span data-stu-id="b4171-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="b4171-105">Участнику следует проверить наличие ожидающих параметров больших двоичных объектов и либо полностью прочитать их, либо освободить их.</span><span class="sxs-lookup"><span data-stu-id="b4171-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="b4171-106">Пример</span><span class="sxs-lookup"><span data-stu-id="b4171-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="b4171-107">Код</span><span class="sxs-lookup"><span data-stu-id="b4171-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="b4171-108">См. также:</span><span class="sxs-lookup"><span data-stu-id="b4171-108">See Also</span></span>  
 [<span data-ttu-id="b4171-109">Большие двоичные объекты и объекты OLE</span><span class="sxs-lookup"><span data-stu-id="b4171-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
