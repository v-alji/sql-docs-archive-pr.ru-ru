...
##  <a name="cross-database-queries"></a><a name="cross_database_queries"></a>Межбазовые запросы  
...
##  <a name="encrypted-data"></a><a name="encrypted_data"></a>Зашифрованные данные  
...
##  <a name="user-defined-error-messages"></a><a name="user_defined_error_messages"></a>Определяемые пользователем сообщения об ошибках  
...
##  <a name="extended-stored-procedures"></a><a name="extended_stored_procedures"></a>Расширенные хранимые процедуры  
...
##  <a name="full-text-engine-for-sql-server-properties"></a><a name="ifts_service_properties"></a>Средство полнотекстового поиска для SQL Server свойств  
...
##  <a name="jobs"></a><a name="jobs"></a>Вакансии  
...
-   [Настройка агента SQL Server](../../ssms/agent/sql-server-agent.md) (при установке экземпляра [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)])  
...
##  <a name="replication-settings"></a><a name="replication_settings"></a>Параметры репликации  
...
##  <a name="service-broker-applications"></a><a name="sb_applications"></a>Service Broker приложения  
...
##  <a name="startup-procedures"></a><a name="startup_procedures"></a>Процедуры запуска  
...
##  <a name="triggers-at-server-level"></a><a name="triggers"></a>Триггеры (на уровне сервера)  
