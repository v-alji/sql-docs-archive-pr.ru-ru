...
|LoginName|`nvarchar`|Имя входа пользователя (либо имени [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] входа безопасности, либо учетные данные входа Windows в формате *домен* \\ *имя_пользователя*).|11|Нет|  
