...
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="dc410-102">Справочник по SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="dc410-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="dc410-103">В этом разделе содержатся сведения о SQL Server Express LocalDB.</span><span class="sxs-lookup"><span data-stu-id="dc410-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="dc410-104">Справочник по сообщениям об ошибках SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="dc410-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="dc410-105">Справочник по API экземпляра SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="dc410-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="dc410-106">Образец кода</span><span class="sxs-lookup"><span data-stu-id="dc410-106">Code Sample</span></span>  
 <span data-ttu-id="dc410-107">В следующем образце демонстрируется использование API-интерфейса LocalDB.</span><span class="sxs-lookup"><span data-stu-id="dc410-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="dc410-108">Перед запуском образца убедитесь в том, что база данных LocalDB установлена на компьютере.</span><span class="sxs-lookup"><span data-stu-id="dc410-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="dc410-109">Базу данных LocalDB вы можете установить из программы установки [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="dc410-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
