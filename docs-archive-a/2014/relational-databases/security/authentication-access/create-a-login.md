...
2.  В диалоговом окне **Добавление объектов** выберите один из следующих параметров: **определенные объекты..**., **все объекты типов...** или_server_name_ **сервера**. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
  
    > [!NOTE]  
    >  Выбор **сервера**_server_name_ автоматически заполняет верхнюю сетку всеми защищаемыми объектами этих серверов.  
