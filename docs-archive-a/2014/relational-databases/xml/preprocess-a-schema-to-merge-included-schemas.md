...
ms.locfileid: "87738063"
---
# <a name="preprocess-a-schema-to-merge-included-schemas"></a><span data-ttu-id="85086-102">Предпроцессор схемы для слияния включаемых схем</span><span class="sxs-lookup"><span data-stu-id="85086-102">Preprocess a Schema to Merge Included Schemas</span></span>
  <span data-ttu-id="85086-103">Элемент W3C XSD **include** обеспечивает поддержку модульного принципа, при котором схема XML может быть разделена на несколько физических файлов.</span><span class="sxs-lookup"><span data-stu-id="85086-103">The W3C XSD **include** element provides support for schema modularity in which an XML schema can be partitioned into more than one physical file.</span></span> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] <span data-ttu-id="85086-104">не поддерживает этот элемент.</span><span class="sxs-lookup"><span data-stu-id="85086-104">currently does not support this element.</span></span> <span data-ttu-id="85086-105">XML-схемы, содержащие данный элемент, будут отклонены сервером.</span><span class="sxs-lookup"><span data-stu-id="85086-105">XML schemas that include this element will be rejected by the server.</span></span>  
  
 <span data-ttu-id="85086-106">Чтобы решить эту проблему, можно предварительно обработать XML-схемы, включающие директиву \<xsd:include>, произведя копирование и слияние содержимого любых включенных схем в единую схему для ее последующей загрузки на сервер.</span><span class="sxs-lookup"><span data-stu-id="85086-106">As a solution, XML schemas that include the \<xsd:include> directive can be preprocessed to copy and merge the contents of any included schemas into a single schema for uploading to the server.</span></span> <span data-ttu-id="85086-107">Для такой предварительной обработки можно использовать следующий код С#.</span><span class="sxs-lookup"><span data-stu-id="85086-107">The following C# code can be used for the preprocessing.</span></span> <span data-ttu-id="85086-108">Примечания в начале этого кода содержат сведения по его использованию.</span><span class="sxs-lookup"><span data-stu-id="85086-108">The comments in the early part of the code provide information about how to use it.</span></span>  
...
## <a name="testing-the-preprocessor-tool"></a><span data-ttu-id="85086-109">Проверка препроцессора</span><span class="sxs-lookup"><span data-stu-id="85086-109">Testing the Preprocessor Tool</span></span>  
 <span data-ttu-id="85086-110">Для проверки препроцессора можно использовать следующие XSD-схемы:</span><span class="sxs-lookup"><span data-stu-id="85086-110">You can use the following XSD schemas to test the preprocessor tool:</span></span>  
  
### <a name="books_commonxsd"></a><span data-ttu-id="85086-111">books_common.xsd</span><span class="sxs-lookup"><span data-stu-id="85086-111">books_common.xsd</span></span>  
...
### <a name="booksxsd"></a><span data-ttu-id="85086-112">books.xsd</span><span class="sxs-lookup"><span data-stu-id="85086-112">books.xsd</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="85086-113">См. также:</span><span class="sxs-lookup"><span data-stu-id="85086-113">See Also</span></span>  
 [<span data-ttu-id="85086-114">Коллекции XML-схем (SQL Server)</span><span class="sxs-lookup"><span data-stu-id="85086-114">XML Schema Collections &#40;SQL Server&#41;</span></span>](xml-schema-collections-sql-server.md)  
