...
-   **Перед началом работы**  
     ...
     [Типичные реализации](#Implementations)  
...
4.  В меню **Конструктор таблиц** выберите пункт **Индексы/Ключи**.  
...
7.  В диалоговом окне **Выбор столбцов из**_table_name_ установите флажки для столбцов таблицы или столбцов, которые будут добавлены к некластеризованному индексу.  
