...
## <a name="in-this-section"></a>в этом разделе  
 [События и ошибки ядро СУБД](database-engine-events-and-errors.md) Описывает формат [!INCLUDE[ssDE](../../includes/ssde-md.md)] сообщений об ошибках и объясняет, как просматривать сообщения об ошибках и возвращать сообщения об ошибках в приложения.  
