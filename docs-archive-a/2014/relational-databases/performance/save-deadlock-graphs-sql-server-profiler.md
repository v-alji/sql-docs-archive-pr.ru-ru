...
10. Щелкните **Все пакеты XML взаимоблокировок в один файл** , чтобы сохранить события графа взаимоблокировок в одном XML-файле, или **Каждый пакет XML взаимоблокировок в отдельный файл**, чтобы создавать новые XML-файлы для каждого графа взаимоблокировок.  
 ...
 После сохранения файла взаимоблокировок его можно открыть в среде [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. Дополнительные сведения см. [в разделе Открытие, просмотр и печать файла взаимоблокировок &#40;SQL Server Management Studio&#41;](open-view-and-print-a-deadlock-file-sql-server-management-studio.md).  
