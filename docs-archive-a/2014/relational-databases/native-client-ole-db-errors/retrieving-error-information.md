...
ms.locfileid: "87667061"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="e88db-102">Получение информации об ошибке</span><span class="sxs-lookup"><span data-stu-id="e88db-102">Retrieving Error Information</span></span>
  <span data-ttu-id="e88db-103">Этот пример получает сведения от различных интерфейсов ошибок, предоставляемых [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поставщиком собственного клиента OLE DB.</span><span class="sxs-lookup"><span data-stu-id="e88db-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="e88db-104">См. также:</span><span class="sxs-lookup"><span data-stu-id="e88db-104">See Also</span></span>  
 [<span data-ttu-id="e88db-105">ошибки</span><span class="sxs-lookup"><span data-stu-id="e88db-105">Errors</span></span>](errors.md)  
