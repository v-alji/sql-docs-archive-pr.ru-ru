...
3.  Злоумышленник создает ссылку на веб-страницу или сервер отчетов, задавая значение параметра в виде «JavaScript: \<malicious script here> », и отправляет эту ссылку другому лицу при атаке «отвлекающих».  
