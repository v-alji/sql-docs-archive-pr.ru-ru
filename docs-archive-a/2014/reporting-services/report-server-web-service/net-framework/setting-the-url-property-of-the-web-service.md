...
# <a name="setting-the-url-property-of-the-web-service"></a>Задание свойства Url для веб-службы
  В приложениях можно в любое время [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] изменить базовый URL-адрес веб службы сервера отчетов, на которую в настоящее время направляется ваше приложение. Для этого необходимо просто задать свойство **Url** объекта службы. Пример:  
