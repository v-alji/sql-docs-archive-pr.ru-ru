...
### <a name="email-settings"></a>Параметры электронной почты
 ...
 Темой по умолчанию сообщения электронной почты является **предупреждение об \<alert name> изменении данных для **. Можно изменить тему в соответствии со своими потребностями.
