...
5.  Нажмите кнопку **Подключиться**. Сервер отчетов отображается в обозревателе объектов.  
...
|----------------|-----------|-----------------|  
|Сервер отчетов в собственном режиме, подключенный как экземпляр по умолчанию или именованный экземпляр:<br /><br /> \<server name>\<_instance><br /><br /> Соединение с сервером отчетов выполнено через поставщик WMI сервера отчетов.|Просмотр и задание свойств сервера и значений по умолчанию.<br /><br /> Просмотр и отмена заданий.<br /><br /> Создание общих расписаний и управление ими.<br /><br /> Создание, изменение и удаление определений ролей.|Назначено роли системного администратора.|  
