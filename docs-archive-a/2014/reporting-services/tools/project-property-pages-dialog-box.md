...
# <a name="project-property-pages-dialog-box"></a>Диалоговое окно страниц свойств проекта
  Страницы свойств проекта позволяют настраивать свойства развертывания проекта сервера отчетов. Чтобы открыть это диалоговое окно, в меню **проект** выберите пункт _\<Report Project Name>_ **Свойства**.  
 ...
 **Configuration Manager**  
 Служит для управления конфигурациями всего решения или добавления новых конфигураций. Дополнительные сведения см [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] . в документации.  
