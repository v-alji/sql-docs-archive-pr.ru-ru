 ...
 **ExternalImagesTimeout**  
 Определяет период времени, в течение которого должен быть получен внешний файл изображения до истечения времени ожидания соединения. Значение по умолчанию — `600` секунды.  
 ...
 **EditSessionTimeout**  
 Указывает количество секунд до истечения времени ожидания сеанса изменения отчета. Значение по умолчанию — 7200 секунд (2 часа).  
