...
##  <a name="how-to-topics"></a><a name="HowTo"></a>Разделы руководства  
 ...
 [Проверка наличия обновлений или отключение обновлений &#40;построитель отчетов и служб SSRS&#41;](../../2014/reporting-services/check-for-updates-or-turn-updates-off-report-builder-and-ssrs.md)  
...
## <a name="see-also"></a>См. также:  
 ...
 [Построитель отчетов 3 части отчетов в SQL Server 2008 R2 (видео)](https://technet.microsoft.com/edge/Video/ff711300)   
 [Инструкции: создание частей отчетов, доступных для повторного использования, с помощью построителя отчетов SQL Server (видеоролик)](https://technet.microsoft.com/sqlserver/ff634166.aspx)  
