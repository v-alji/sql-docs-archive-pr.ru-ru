...
## <a name="setting-delivery-options"></a>Настройка параметров доставки  
 ...
 путь  
 Указывает полный URL-адрес библиотеки SharePoint, включая имя сайта и веб-приложения SharePoint. Например: <http://mySharePointWeb/MySite/MyDocLib> ; где " <http://mySharePointWeb> " обозначает веб-приложение, "личный сайт" — это узел SharePoint, а "Библиотека" — Библиотека SharePoint, в которой будет доставлен отчет.  
