...
---
# <a name="installationid-property-wmi-msreportserver_configurationsetting"></a>Свойство InstallationID (WMI MSReportServer_ConfigurationSetting)
  Это свойство возвращает уникальный идентификатор для определенного экземпляра сервера отчетов.  
