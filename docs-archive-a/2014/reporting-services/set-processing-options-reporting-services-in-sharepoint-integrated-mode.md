...
##  <a name="to-set-data-refresh-options"></a><a name="bkmk_set_data_refresh"></a>Задание параметров обновления данных  
...
##  <a name="to-set-report-caching-options"></a><a name="bkmk_set_report_caching"></a>Установка параметров кэширования отчета  
...
##  <a name="to-set-processing-time-out-values"></a><a name="bkmk_set_processing"></a>Установка значений времени ожидания обработки  
...
##  <a name="to-set-report-history-options-and-limits"></a><a name="bkmk_set_report_history"></a>Установка параметров и ограничений журнала отчета  
...
##  <a name="set-database-timeout"></a><a name="bkmk_set_database_timeout"></a>Задать время ожидания базы данных  
