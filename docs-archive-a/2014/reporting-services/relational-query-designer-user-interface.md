...
|---------------|-----------------|  
|Сред.|Возвращает среднее арифметическое значений в группе. Реализует агрегат SQL AVG.|  
...
|Минимум|Возвращает минимальное значение в группе. Реализует статистическое выражение SQL MIN.|  
|Максимум|Возвращает максимальное значение в группе. Реализует статистическое выражение SQL MAX.|  
