...
# <a name="tutorial-creating-drillthrough-and-main-reports-report-builder"></a>Учебник. Создание детализированных и главных отчетов (построитель отчетов)
 ...
 На следующем рисунке показано, как значения поля, игры и Toys в основном отчете отображаются в заголовке детализированного отчета. Данные в детализированном отчете относятся к категории продуктов «Игры и игрушки».  
...
3.  [Добавление столбцов для отображения значений продаж в спарклайна](#DSparkline)  
...
1.  Нажмите кнопку **Пуск**, укажите пункт **программы**, выберите пункт [!INCLUDE[ssCurrentUI](../includes/sscurrentui-md.md)] **Построитель отчетов**, а затем щелкните **Построитель отчетов**.  
     ...
     Откроется диалоговое окно **Приступая к работе** . Если кнопка не отображается, нажмите кнопку **создать**в **Построитель отчетов** .  
...
##  <a name="1a-specify-a-data-connection"></a><a name="DConnection"></a>SR1a. Задание подключения к данным  
...
12. Нажмите кнопку **Проверить соединение**, чтобы проверить соединение с источником данных.  
     ...
     Подключение сообщения **успешно создано** .  
  
13. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
14. Щелкните **Далее**.  
  
##  <a name="1b-create-an-mdx-query"></a><a name="DMDXQuery"></a>1b. Создание запроса многомерных выражений  
...
1.  На странице **Конструирование запроса** на панели Метаданные нажмите кнопку **(...)**.  
  
2.  В диалоговом окне **Выбор куба** выберите Sales и нажмите кнопку **ОК**.  
  
    > [!TIP]  
    >  Если вы не хотите создавать запрос многомерных выражений вручную, щелкните значок ![Перейти в режим конструктора](media/rsqdicon-designmode.gif "Перейти в режим конструктора"), переключите конструктор запросов в режим "Запрос", вставьте в конструктор законченное многомерное выражение и перейдите к шагу 6 раздела [Создание набора данных](#DSkip).  
...
##  <a name="1c-organize-data-into-groups"></a><a name="DLayout"></a>1C. Упорядочение данных по группам  
...
4.  Перетащите элемент Объем_продаж в область **Значения**.  
     ...
     Объем_продаж автоматически вычисляется с помощью функции Sum, используемой по умолчанию для статистических вычислений. Значение — `[Sum(Sales_Amount)]`.  
...
##  <a name="1d-add-subtotals-and-totals"></a><a name="DTotals"></a>1д. Добавление подытогов и итогов  
...
1.  На странице **Выбор макета** в разделе **Параметры**убедитесь, что выбран параметр **Показывать подытоги и общие итоги** .  
...
1.  На странице **Выбор стиля** на панели Стили выберите элемент содержание.  
...
##  <a name="3-add-columns-to-show-sales-values-in-sparklines"></a><a name="DSparkline"></a>3. Добавление столбцов для отображения значений продаж в спарклайнах  
...
##  <a name="4-add-report-title-with-product-category-name"></a><a name="DReportTitle"></a>4. Добавление заголовка отчета с названием категории продукта  
...
##  <a name="1-create-a-new-report-from-the-table-or-matrix-wizard"></a><a name="MMatrixAndDataset"></a>1. Создание нового отчета с помощью мастера таблицы или матрицы  
...
##  <a name="1a-specify-a-data-connection"></a><a name="MConnection"></a>SR1a. Задание подключения к данным  
...
6.  В поле **имя сервера**введите имя сервера, на котором [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] установлен экземпляр.  
...
##  <a name="1b-create-an-mdx-query"></a><a name="MMDXQuery"></a>1b. Создание запроса многомерных выражений  
...
1.  На странице **Проектирование запроса** на панели Метаданные в разделе Куб нажмите кнопку с многоточием **(...)**.  
...
6.  Разверните измерение территория продаж, а затем перетащите группу территории продаж в столбец **Иерархия** под **именем канала**.  
...
##  <a name="1c-organize-data-into-groups"></a><a name="MLayout"></a>1C. Упорядочение данных по группам  
 При выборе полей для группирования данных создается матрица со строками и столбцами, отображающими подробные и агрегированные данные.  
...
3.  Перетащите поле `Net_QTY` в область **Значения**.  
     ...
     `Net_QTY` автоматически вычисляется с помощью функции Sum, используемой по умолчанию для агрегирования числовых полей. Значение — `[Sum(Net_QTY)]`.  
...
##  <a name="1d-add-subtotals-and-totals"></a><a name="MTotals"></a>1д. Добавление подытогов и итогов  
...
##  <a name="2-remove-the-grand-total-row"></a><a name="MGrandTotal"></a>2. Удаление строки общего итога  
...
##  <a name="3-configure-text-box-action-for-drillthrough"></a><a name="MDrillthrough"></a>3. действие "настроить текстовое поле" для детализации  
...
##  <a name="5-update-parameter-properties"></a><a name="MParameter"></a>5. свойства параметров обновления  
