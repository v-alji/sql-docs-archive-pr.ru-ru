...
3.  Для внедренного источника данных убедитесь, что выбран параметр **Внедренное соединение** .  
...
4.  Для общего источника данных убедитесь, что выбран параметр **использовать ссылку на общий источник данных** .  
...
-   В области данных отчета щелкните правой кнопкой мыши источник данных и выберите пункт **Свойства источника данных**.  
  
-   Щелкните **Внедренное соединение** и завершите создание внедренного источника данных, как описано в предыдущей процедуре.  
  
## <a name="see-also"></a>См. также:  
 [Хранение учетных данных в Reporting Services источнике данных](report-data/store-credentials-in-a-reporting-services-data-source.md)   
 ...
 [Преобразование источника данных из встроенного в общие &#40;построитель отчетов и службы SSRS&#41;](report-data/convert-data-sources-report-builder-and-ssrs.md)   
