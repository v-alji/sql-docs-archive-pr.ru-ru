...
|----------|-----------------|------------|
|![Значок отчета](media/hlp-16doc.gif "Значок отчета")|Отчет|Чтобы открыть отчет, щелкните его значок или имя. Отчет откроется в отдельном окне.|
