...
### <a name="backup-the-encryption-keys-using-central-administration"></a>Выполните резервное копирование ключей шифрования, с помощью центра администрирования  
 Сведения о резервном копировании [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] ключей шифрования см. в разделе "ключи шифрования" раздела [Управление приложением службы Reporting Services SharePoint](../../2014/reporting-services/manage-a-reporting-services-sharepoint-service-application.md).  
...
### <a name="restore-the-encryption-keys-using-central-administration"></a>Восстановление ключей шифрования с помощью центра администрирования  
 Сведения о восстановлении [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] ключей шифрования см. в разделе "ключи шифрования" раздела [Управление приложением службы Reporting Services SharePoint](../../2014/reporting-services/manage-a-reporting-services-sharepoint-service-application.md).  
