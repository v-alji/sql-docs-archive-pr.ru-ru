...
# <a name="enter-data-source-credentials-dialog-box"></a>Диалоговое окно «Ввод учетных данных для источника данных»
  Диалоговое окно **Ввод учетных данных источника данных** используется для предоставления [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] учетных данных, чтобы можно было получать данные из источника данных.  
