...
2.  Выберите область данных в области конструктора, а затем щелкните правой кнопкой мыши _\<data region>_ **свойства**. Для датчика выберите пункт **Свойства панели датчиков**. _\<data region>_ Откроется диалоговое окно **свойства** .  
