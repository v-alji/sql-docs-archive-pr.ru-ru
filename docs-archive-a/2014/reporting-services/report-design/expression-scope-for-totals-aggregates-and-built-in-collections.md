...
##  <a name="synchronizing-scales-for-sparklines"></a><a name="Sparklines"></a>Синхронизация шкал для спарклайнов  
...
##  <a name="specifying-scopes-from-the-page-header-or-page-footer"></a><a name="Page"></a>Указание областей из верхнего или нижнего колонтитула страницы  
...
##  <a name="specifying-a-toggle-item-for-drilldown-and-conditional-visibility"></a><a name="Toggles"></a>Указание переключаемого элемента для углубленной детализации и условной видимости  
...
##  <a name="specifying-a-sort-expression-to-synchronize-sort-order"></a><a name="Sort"></a>Указание выражения сортировки для синхронизации порядка сортировки  
...
##  <a name="suppressing-null-or-zero-values-in-a-cell"></a><a name="Nulls"></a>Подавление нулевых или нулевых значений в ячейке  
...
## <a name="see-also"></a>См. также:  
 ...
 [Примеры выражений групп &#40;построитель отчетов и SSRS&#41;](group-expression-examples-report-builder-and-ssrs.md)   
 [Создание групп рекурсивной иерархии &#40;построитель отчетов и SSRS&#41;](creating-recursive-hierarchy-groups-report-builder-and-ssrs.md)   
