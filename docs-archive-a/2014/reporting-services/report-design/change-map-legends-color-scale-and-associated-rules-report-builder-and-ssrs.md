...
1.  В представление конструирования щелкните правой кнопкой мыши условные обозначения и откройте _\<report item->_ страницу **свойства** .  
  
2.  В разделе **Позиция**щелкните место, где должны отображаться условные обозначения относительно области отображения.  
  
3.  Чтобы отобразить условные обозначения вне окна просмотра, выберите **Показать \<report item> внешнее окно просмотра**.  
...
##  <a name="to-show-or-hide-a-map-legend-title"></a><a name="MapLegendTitle"></a> Отображение или скрытие заголовка условных обозначений карты  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, и выберите пункт _\<map element type\>_ **правило цвета**.  
...
3.  Выберите параметр **визуализировать данные с помощью** \<rule type\> . Чтобы использовать параметры распределения, нужно создать диапазоны на странице **Распределение** на основании аналитических данных, связанных со слоем.  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, и выберите пункт _\<map element type\>_ **правило**.  
  
3.  Убедитесь, что выбран параметр **визуализировать данные с помощью** \<*rule type*> .  
...
##  <a name="to-change-the-contents-of-the-color-scale"></a><a name="ColorScale"></a> Изменение содержимого цветовой шкалы  
...
3.  Выберите параметр правила цвета, который нужно использовать. Для отображения элементов в условных обозначениях или цветовой шкале на карте необходимо выбрать один из **визуализаций данных с помощью** \<rule type> параметров.  
