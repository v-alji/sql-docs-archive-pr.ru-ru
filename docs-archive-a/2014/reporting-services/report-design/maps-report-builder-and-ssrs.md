...
-   **Отчеты галереи карт.** Пространственные данные внедряются в отчеты, находящиеся в коллекции карт. По умолчанию коллекция карт устанавливается в *\<drive>* папку: \Program FILES\MICROSOFT SQL Server\Report Builder builder\mapgallery.  
...
-   Из источника пространственных данных:  
    ...
    -   **Гистограмм.** Поле, содержащее название области.  
  
-   Из источника аналитических данных:  
  
    -   **Повтор.** Поле, содержащее население города.  
  
    -   **Город.** . Поле, содержащее название города.  
  
    -   **Гистограмм.** Поле, содержащее название области, штата или территории.  
...
-   Мозаичный тип. Поддерживаются следующие стили:  
    ...
    -   **Road.** Отображает стиль карты дорог, с белым фоном, дорогами и текстом меток.  
  
    -   **Воздушный.** Отображает картину, как при виде с воздуха, без текста.  
  
    -   **Гибридного.** Отображает сочетание стилей **Дорожный** и **Воздушный** .  
...
##  <a name="understanding-map-layers-and-map-elements"></a><a name="MapLayers"></a>Основные сведения о слоях карт и элементах карт  
...
##  <a name="troubleshooting-maps"></a><a name="Troubleshooting"></a>Устранение неполадок карт  
 ...
 Дополнительные сведения о проблемах, связанных с отчетами-картами, см. в разделе [Устранение неполадок в отчетах: отчеты-карты (построитель отчетов и службы SSRS)](troubleshoot-reports-map-reports-report-builder-and-ssrs.md)  
