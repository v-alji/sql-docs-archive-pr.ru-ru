...
## <a name="borders-lines-and-gridlines"></a>Границы, линии и сетки  
 ...
 Границу можно также добавить в сам отчет. Дополнительные сведения см. в разделе [Добавление границы в отчет (построитель отчетов и службы SSRS)](add-a-border-to-a-report-report-builder-and-ssrs.md).  
