...
##  <a name="understanding-a-filter-equation"></a><a name="FilterEquations"></a>Основные сведения о уравнении фильтра  
...
|**Окне**|Проверяет, содержится ли выражение в наборе значений.|  
