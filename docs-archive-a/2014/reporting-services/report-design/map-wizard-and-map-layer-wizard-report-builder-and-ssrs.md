...
###  <a name="what-is-an-esri-shapefile"></a><a name="Shapefile"></a>Что такое фигуры ESRI?
 Файл фигуры ESRI представляет собой набор файлов данных, соответствующих формату хранения файла фигуры пространственных данных Института исследования окружающей среды (Environmental Systems Research Institute, ESRI). Набор файлов обычно включает *\<filename>* SHP-файл, содержащий пространственные данные, и файл поддержки, *\<filename>* . dbf.
