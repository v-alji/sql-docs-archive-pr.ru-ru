...
-   Небольшие элементы отчета, такие как текстовые поля или прямоугольники, для которых явно задано свойство не разрывать на `true` .  
  
-   Большие элементы отчета, например вложенные отчеты или элемент табликса, не являющийся самым внутренним, с явно заданным свойством не разрывать `true` .  
  
-   Области данных табликса с явно заданным свойством, равным `true` .  
