...
1.  [Создание нового отчета, начиная со страницы «Приступая к работе»](#CreateTable)  
...
##  <a name="1-create-a-new-report-from-getting-started"></a><a name="CreateTable"></a>1. Создание нового отчета на основе начало работы  
 Создайте табличный отчет из диалогового окна **Начало работы** . Имеется два режима: конструктор отчетов и конструктор общего набора данных. В режиме конструктора отчетов данные задаются в области данных отчета, а макет отчета — в области конструктора. В режиме конструктора общего набора данных создаются запросы к наборам данных для совместного использования. В этом учебнике будет использоваться режим конструктора отчетов.  
...
##  <a name="1a-specify-a-data-connection-in-the-table-wizard"></a><a name="DataConnection"></a>SR1a. Указание подключения к данным в мастере таблиц  
...
3.  В поле **имя**введите **продажи продукта** имя для источника данных.  
...
##  <a name="1b-create-a-query-in-the-table-wizard"></a><a name="Query"></a>1b. Создание запроса в мастере таблиц  
...
1.  На странице **Создание запроса** открывается конструктор реляционных запросов. В этом учебнике будет использоваться текстовый конструктор запросов.  
     ...
     Нажмите кнопку **изменить как текст**. Текстовый конструктор запросов отображает панель запросов и панель результатов.  
...
##  <a name="1c-organize-data-into-groups-in-the-table-wizard"></a><a name="Groups"></a>1C. Организация данных в группы в мастере таблиц  
...
1.  На странице **Размещение полей** перетащите элемент Product в область **значения**.  
...
##  <a name="1d-add-subtotal-and-total-rows-in-the-table-wizard"></a><a name="Subtotals"></a>1д. Добавление строк подытога и итога в мастере таблиц  
...
##  <a name="1e-choose-a-style-in-the-table-wizard"></a><a name="Style"></a>1E. Выбор стиля в мастере таблиц  
 Стиль задает стиль шрифта, набор цветов и стиль границы.  
  
#### <a name="to-specify-a-table-style"></a>Задание стиля таблицы  
  
1.  На странице **Выбор стиля** на панели Стили выберите океанские.  
...
##  <a name="3-format-data-as-date"></a><a name="FormatDate"></a>3. Форматирование данных в формате даты  
...
3.  . На панели «Свойства» выберите свойство InitialPageName и введите « **продажи продукта Excel**».  
...
2.  . На ленте нажмите кнопку **Экспорт**, а затем выберите пункт **Excel**.  
  
     Откроется диалоговое окно **Сохранить как**.  
  
3.  Перейдите в папку **документы** .  
  
4.  В текстовом поле **имя файла** введите **продукт Sales Excel**.  
  
5.  Убедитесь, что файл имеет тип **Книга Excel**.  
  
6.  Выберите команду **Сохранить**.  
  
#### <a name="to-view-the-report-in-excel"></a>Просмотр отчета в Excel  
  
1.  Откройте папку **документы** и дважды щелкните **продукт продажи продуктов Excel.xlsx**.  
