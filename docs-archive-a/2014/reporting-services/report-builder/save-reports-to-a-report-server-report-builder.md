...
1.  В построителе отчетов нажмите кнопку **Сохранить**. **Save As** _\<Report Item\>_ Откроется диалоговое окно Сохранить как.  
...
1.  Нажмите кнопку «Построитель отчетов» и выберите **Сохранить как**. **Save As** _\<Report Item\>_ Откроется диалоговое окно Сохранить как.  
