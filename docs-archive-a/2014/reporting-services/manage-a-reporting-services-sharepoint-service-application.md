 ...
 **Учетная запись** Введите учетную запись пользователя домена Windows Используйте следующий формат: * \<domain> \\<учетная \> запись пользователя*.
