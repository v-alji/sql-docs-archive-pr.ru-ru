...
[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Надстройка служб (SSRS) для продуктов и технологий SharePoint (rsSharePoint.msi) — это веб-Загрузка, которая предоставляет функции для интеграции сервера отчетов с развертыванием SharePoint.  
