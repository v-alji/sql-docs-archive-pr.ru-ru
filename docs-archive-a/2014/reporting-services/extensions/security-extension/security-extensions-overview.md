...
# <a name="security-extensions-overview"></a>Общие сведения о модулях безопасности
 ...
 ![Процесс модуля безопасности Reporting Services](../../media/rosettasecurityextensionflow.gif "Процесс модуля безопасности Reporting Services")
...
## <a name="see-also"></a>См. также:
 [Реализация модуля безопасности](../security-extension/implementing-a-security-extension.md) [Настройка диспетчер отчетов для передачи файлов cookie для пользовательской проверки подлинности](../../security/configure-the-web-portal-to-pass-custom-authentication-cookies.md)
