...
4.  Добавьте запись для модуля обработки данных, включающего элемент **Extension** со значениями `Name` `Type` атрибутов, и `Visible` . Эта запись должна иметь следующий вид:  
