---
title: Представление ключевого показателя эффективности (табличное) | Документация Майкрософт
ms.custom: ''
ms.date: 04/27/2017
...
ms.locfileid: "87738858"
---
# <a name="key-performance-indicator-representation-tabular"></a><span data-ttu-id="5c993-102">Представление ключевого показателя эффективности (табличное)</span><span class="sxs-lookup"><span data-stu-id="5c993-102">Key Performance Indicator Representation (Tabular)</span></span>
  <span data-ttu-id="5c993-103">KPI служит показателем производительности значения, определяемого базовой мерой, относительно целевого значения</span><span class="sxs-lookup"><span data-stu-id="5c993-103">A KPI is used to gauge performance of a value, defined by a Base measure, against a Target value</span></span>  
  
## <a name="key-performance-indicator-representation"></a><span data-ttu-id="5c993-104">Представление ключевого показателя эффективности</span><span class="sxs-lookup"><span data-stu-id="5c993-104">Key Performance Indicator Representation</span></span>  
 <span data-ttu-id="5c993-105">В табличных объектных моделях ключевой показатель эффективности — ключевой показатель эффективности — это мера с дополнительными сведениями о том, что клиентское приложение отображает его графически.</span><span class="sxs-lookup"><span data-stu-id="5c993-105">In tabular object models a key performance indicator -kpi- is a measure with additional information for the client application to display it graphically.</span></span> <span data-ttu-id="5c993-106">Ключевой показатель эффективности обычно содержит данные о заданной цели, состояние меры по сравнению с целью и сведения, сообщающие клиентскому средству о том, каким образом следует графически представить состояние.</span><span class="sxs-lookup"><span data-stu-id="5c993-106">A kpi usually has information about a goal to be obtained, the status of the measure compared to a the goal, and information for the client tool on how to display graphically the status.</span></span>  
  
### <a name="key-performance-indicator-in-amo"></a><span data-ttu-id="5c993-107">Ключевой показатель эффективности в объектах AMO</span><span class="sxs-lookup"><span data-stu-id="5c993-107">Key Performance Indicator in AMO</span></span>  
 <span data-ttu-id="5c993-108">Если для управления KPI табличной модели используются объекты AMO, не существует сопоставления типа «один к одному» для KPI, и для этого не используется объект AMO <xref:Microsoft.AnalysisServices.Kpi>. В AMO для табличных моделей KPI представляется рядом объектов, созданных в одном из элементов коллекции <xref:Microsoft.AnalysisServices.MdxScript.Commands%2A> и в <xref:Microsoft.AnalysisServices.MdxScript.CalculationProperties%2A>.</span><span class="sxs-lookup"><span data-stu-id="5c993-108">When using AMO to manage a Tabular Model kpi there is no one-to-one object match for a kpi in AMO, the AMO <xref:Microsoft.AnalysisServices.Kpi>object is not used for this purpose; in AMO, for tabular models, a kpi is represented the by a series of objects created in one of the elements in the <xref:Microsoft.AnalysisServices.MdxScript.Commands%2A> collection and in the <xref:Microsoft.AnalysisServices.MdxScript.CalculationProperties%2A>.</span></span>  
  
 <span data-ttu-id="5c993-109">В следующем фрагменте кода показано, как создать одно из многих возможных определений KPI.</span><span class="sxs-lookup"><span data-stu-id="5c993-109">The following code snippet shows how to create one of many possible kpi definitions.</span></span>  
...
## <a name="amo2tabular-sample"></a><span data-ttu-id="5c993-110">Образец AMO2Tabular</span><span class="sxs-lookup"><span data-stu-id="5c993-110">AMO2Tabular sample</span></span>  
 <span data-ttu-id="5c993-111">Чтобы получить представление о том, как использовать объекты AMO для создания представлений ключевых показателей эффективности и управления ими, см. исходный код образца объектов AMO в табличном виде. в частности, верните следующий исходный файл: AddKPIs.cs.</span><span class="sxs-lookup"><span data-stu-id="5c993-111">To have an understanding on how to use AMO to create and manipulate Key Performance Indicator representations see the source code of the AMO to Tabular sample; specifically check in the following source file: AddKPIs.cs.</span></span> <span data-ttu-id="5c993-112">Этот образец доступен на сайте Codeplex.</span><span class="sxs-lookup"><span data-stu-id="5c993-112">The sample is available at Codeplex.</span></span> <span data-ttu-id="5c993-113">Важное примечание о коде. Код предоставляется только для иллюстрации логических концепций, поясняемых в этом разделе. Его не следует использовать в рабочей среде или для других целей, за исключением учебных.</span><span class="sxs-lookup"><span data-stu-id="5c993-113">An important note about the code: the code is provided only as a support to the logical concepts explained here and should not be used in a production environment; nor should it be used for other purpose other than the pedagogical one.</span></span>  
