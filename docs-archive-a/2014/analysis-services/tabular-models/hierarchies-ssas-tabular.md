...
##  <a name="defining-hierarchies"></a><a name="bkmk_define"></a>Определение иерархий  
...
|Задача|Описание|  
|----------|-----------------|  
|[Создание иерархий и управление ими (табличные службы SSAS)](hierarchies-ssas-tabular.md)|Описание создания иерархий и управления ими с помощью конструктора моделей в представлении диаграммы.|  
