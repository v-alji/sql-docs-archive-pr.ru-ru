...
##  <a name="project-properties"></a><a name="bkmk_proj_properties"></a>Свойства проекта  
...
|**Version**|**11,0**|Версия экземпляра служб Analysis Services, на котором будет развернут проект.|  
...
###  <a name="to-configure-deployment-options-and-deployment-server-property-settings"></a><a name="bkmk_conf_proj_settings"></a>Настройка параметров развертывания и свойств сервера развертывания  
