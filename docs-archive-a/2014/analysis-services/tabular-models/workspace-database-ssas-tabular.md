...
|Раздел|Описание|  
|-----------|-----------------|  
|[Свойства модели (табличные службы SSAS)](model-properties-ssas-tabular.md)|Содержит описания и шаги настройки для свойств базы данных рабочей области модели.|  
  
## <a name="see-also"></a>См. также:  
 [Настройка моделирования данных по умолчанию и свойств развертывания &#40;табличных&#41;SSAS](configure-default-data-modeling-and-deployment-properties-ssas-tabular.md)   
