...
|Минимум|Возвращает минимальное значение в группе. Реализует агрегат SQL MIN.|  
|Максимум|Возвращает максимальное значение в группе. Реализует агрегат SQL MAX.|  
