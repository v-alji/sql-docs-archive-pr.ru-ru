 ...
 **Примечание** . **Мастер статистических схем** и **Мастер оптимизации с учетом использования** недоступны в этом представлении.  
...
|**Удалить**|Нажмите, чтобы удалить выбранный агрегат или выбранную статистическую схему.|  
