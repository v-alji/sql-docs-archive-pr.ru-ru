...
-   [Открытие книги или отчета в режиме полной страницы](#view)
...
##  <a name="icons-in-powerpivot-gallery"></a><a name="icons"></a>Значки в галерее PowerPivot
...
##  <a name="save-an-excel-workbook-to-powerpivot-gallery"></a><a name="add"></a>Сохранение книги Excel в галерее PowerPivot
...
##  <a name="create-new-reports-or-workbooks-based-on-a-published-powerpivot-workbook"></a><a name="newdocs"></a>Создание новых отчетов или книг на основе опубликованной книги PowerPivot
...
##  <a name="open-a-workbook-or-report-in-full-page-mode"></a><a name="view"></a> Открыть книгу или отчет в полностраничном режиме
...
##  <a name="schedule-data-refresh-for-powerpivot-workbooks-in-powerpivot-gallery"></a><a name="newdr"></a>Планирование обновления данных для книг PowerPivot в галерее PowerPivot
...
##  <a name="delete-a-workbook-or-report-in-powerpivot-gallery"></a><a name="delete"></a>Удаление книги или отчета в галерее PowerPivot
...
##  <a name="refresh-a-thumbnail-image"></a><a name="image"></a>Обновить эскиз изображения
