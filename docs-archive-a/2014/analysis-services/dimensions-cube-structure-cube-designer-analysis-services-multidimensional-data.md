 ...
 **Иерархии**  
 ...
 Разверните измерение куба и выберите **изменить \<dimension> ** , чтобы открыть конструктор измерений и изменить измерение базы данных, на котором основано измерение куба. Дополнительные сведения о конструкторе измерений см. в разделе [Конструктор измерений (службы Analysis Services — многомерные данные)](dimension-designer-analysis-services-multidimensional-data.md).  
