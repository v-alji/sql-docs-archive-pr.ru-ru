...
-   **Входные столбцы** В модели упрощенного алгоритма Байеса все столбцы должны быть либо дискретными, либо дискретными столбцами. Сведения о дискретизации столбцов см. в разделе [методы дискретизации &#40;&#41;интеллектуального анализа данных ](discretization-methods-data-mining.md).
