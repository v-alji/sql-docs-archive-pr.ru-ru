 ...
 **Прогнозирующие запросы**  
 ...
 [Прогнозирование взаимосвязей](#bkmk_Query7)  
...
###  <a name="sample-query-2-retrieving-a-summary-of-training-data"></a><a name="bkmk_Query2"></a> Образец запроса 2. Получение сводки данных для обучения  
...
###  <a name="sample-query-3-finding-more-information-about-attributes"></a><a name="bkmk_Query3"></a> Образец запроса 3. Получение дополнительных сведений об атрибутах  
...
###  <a name="sample-query-4-using-system-stored-procedures"></a><a name="bkmk_Query4"></a> Пример запроса 4. Использование системных хранимых процедур  
...
###  <a name="sample-query-5-predicting-outcomes-using-a-singleton-query"></a><a name="bkmk_Query5"></a> Образец запроса 5. Прогноз результатов с помощью одноэлементного запроса  
...
###  <a name="sample-query-6-getting-predictions-with-probability-and-support-values"></a><a name="bkmk_Query6"></a>Образец запроса 6. получение прогнозов со значениями вероятности и поддержки  
