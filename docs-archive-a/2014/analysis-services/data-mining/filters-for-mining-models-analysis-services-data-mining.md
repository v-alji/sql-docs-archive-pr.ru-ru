...
-   Ввод критерия фильтра непосредственно в `Filter` свойство модели интеллектуального анализа данных.  
...
-   В конструкторе перейдите на вкладку **модели интеллектуального анализа данных** , откройте **свойства**и просмотрите `Filter` свойство модели интеллектуального анализа данных.  
...
### <a name="why-cant-i-see-any-effects-from-the-filter"></a>Почему в фильтре не отображаются эффекты?  
