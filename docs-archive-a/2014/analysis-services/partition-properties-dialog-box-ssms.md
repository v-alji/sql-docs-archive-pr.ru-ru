...
|**Общие**|На странице **Общие** можно просмотреть и изменить общие свойства секции, выбранной на странице **Выбор** . Дополнительные сведения об этой странице см. в разделе [Общие (диалоговое окно "Свойства секции") (среда SSMS)](general-partition-properties-dialog-box-ssms.md).|  
