...
3.  В группе **Реляционные источники данных**выбран источник данных **Adventure Works DW 2012** . Щелкните **Далее**.  
...
5.  Нажмите **>** , чтобы добавить выбранные таблицы в список **Включенные объекты** .  
