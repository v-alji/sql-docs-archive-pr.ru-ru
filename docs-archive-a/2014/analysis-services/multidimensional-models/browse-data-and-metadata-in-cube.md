...
|MDX|Многомерное выражение, возвращающее набор элементов|Значения должны входить в набор вычисленных элементов. Если выбрать этот параметр, то открывается диалоговое окно **Построитель вычисленных элементов** , где можно создать многомерное выражение.|  
