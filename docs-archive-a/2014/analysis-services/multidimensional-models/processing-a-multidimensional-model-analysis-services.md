...
##  <a name="choosing-a-tool-or-approach"></a><a name="bkmk_tool"></a>Выбор средства или подхода  
...
##  <a name="processing-objects"></a><a name="bkmk_proc"></a>Обработка объектов  
...
##  <a name="reprocessing-objects"></a><a name="bkmk_reproc"></a>Повторная обработка объектов  
