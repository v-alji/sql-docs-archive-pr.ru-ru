...
-   Пробелы внутри текста сохранены.  
 ...
 Свойства `Name` и `ID` имеют особые ограничения на допустимые символы в строковых элементах. Дополнительные сведения о `Name` `ID` соглашениях и см. в разделе [объекты и характеристики объектов ASSL](assl-objects-and-object-characteristics.md).  
