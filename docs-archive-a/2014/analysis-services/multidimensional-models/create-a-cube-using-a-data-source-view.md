...
>  Для удобства просмотра можно увеличить или полностью развернуть окно мастера.  
 ...
 Можно переименовать любое измерение, атрибут, иерархию или уровень, щелкнув имя или щелкнув правой кнопкой мыши имя, а затем в контекстном меню выберите команду **Переименовать \<object> **, где **\<object>** — это **измерение**, **атрибут**или **уровень**.  
