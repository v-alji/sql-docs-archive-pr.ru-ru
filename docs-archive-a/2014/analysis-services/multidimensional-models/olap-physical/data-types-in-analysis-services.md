...
|Smallint|16-разрядное знаковое целое число. Тип значения *smallint* представляет целые числа со знаком со значениями от отрицательного 32768 до положительного 32767.|  
