...
##  <a name="overview-of-modeling-in-analysis-services"></a><a name="bkmk_overview"></a>Общие сведения о моделировании в Analysis Services  
...
##  <a name="data-source-support-by-solution-type"></a><a name="bkmk_ds"></a>Поддержка источников данных по типу решения  
...
##  <a name="model-features"></a><a name="bkmk_models"></a>Функции модели  
...
##  <a name="model-size"></a><a name="bkmk_modelsize"></a>Размер модели  
...
##  <a name="programmability-and-developer-experience"></a><a name="bkmk_ext"></a>Возможности программирования и разработки  
...
##  <a name="query-and-scripting-language-support"></a><a name="bkmk_lang"></a>Поддержка языка запросов и сценариев  
...
##  <a name="security-feature-support"></a><a name="bkmk_sec"></a>Поддержка функций безопасности  
...
##  <a name="design-tools"></a><a name="bkmk_designer"></a>Средства проектирования  
...
##  <a name="client-and-reporting-applications"></a><a name="bkmk_client"></a>Клиентские и отчеты приложения  
...
##  <a name="server-deployment-modes-for-multidimensional-and-tabular-solutions"></a><a name="bkmk_deploymentmode"></a> Режимы развертывания сервера для многомерных и табличных решений  
...
##  <a name="hosting-platforms"></a><a name="bkmk_sharePoint"></a>Платформы размещения  
...
##  <a name="next-step-build-a-solution"></a><a name="bkmk_Next"></a>Следующий шаг: создание решения  
...
## <a name="see-also"></a>См. также:  
 ...
 [Новые возможности PowerPivot](https://go.microsoft.com/fwlink/?LinkId=238141)   
 [Справка PowerPivot для SQL Server 2012](https://go.microsoft.com/fwlink/?LinkID=220946)   
