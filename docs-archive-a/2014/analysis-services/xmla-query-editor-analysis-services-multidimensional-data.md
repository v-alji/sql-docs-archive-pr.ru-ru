...
|**Отключение**|Отключает текущий редактор запросов XMLA от экземпляра служб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .|  
...
|**Анализ**|Проверяет синтаксис выбранного кода. Если код не выбран, проверяется синтаксис всего окна редактора запросов XMLA.|  
