...
|Значение|Описание|  
|-----------|-----------------|  
|Регулярно|Указывает на обычный атрибут.|  
|Клавиши|Указывает на ключевой атрибут измерения. Соответствует конечным элементам измерения. У измерения может быть только один ключевой атрибут. Для редактирования нажмите кнопку с многоточием (**...**) рядом со свойством **KeyColumns** в панели **Свойства** .|  
