...
##  <a name="1-prepare-the-sharepoint-2013-farm"></a><a name="bkmk_prepare_sharepoint2013"></a>1) Подготовка фермы SharePoint 2013
...
##  <a name="2-backup-copy-restore-the-databases"></a><a name="bkmk_backup_restore"></a>2) резервное копирование, копирование, восстановление баз данных
...
##  <a name="3-prepare-web-applications-and-mount-content-databases"></a><a name="bkmk_prepare_mount_databases"></a>3) подготовка веб-приложений и подключение баз данных содержимого
...
##  <a name="4-upgrade-powerpivot-schedules"></a><a name="bkmk_upgrade_powerpivot_schedules"></a>4) обновление расписаний PowerPivot
