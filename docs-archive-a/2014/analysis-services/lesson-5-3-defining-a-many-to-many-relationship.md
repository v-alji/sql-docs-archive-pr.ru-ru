...
2.  Щелкните правой кнопкой мыши в любом месте панели **Организатор диаграмм** , выберите пункт **создать диаграмму**и укажите в `Internet Sales Order Reasons` качестве имени для новой диаграммы.
...
10. На панели **Таблицы** щелкните правой кнопкой мыши таблицу **InternetSalesReason (dbo.FactInternetSalesReason)** и выберите пункт **Просмотр данных**.
     ...
     ![Ключевое значение, определяющее причину продажи](../../2014/tutorials/media/l5-many-to-many-1.gif "Ключевое значение, определяющее причину продажи")
...
6.  В окне «Свойства» измените значение свойства **Visible** меры **Internet Sales Reason Count** на **False**.
     ...
     ![Свойства меры Internet Sales Reason Count](../../2014/tutorials/media/l5-many-to-many-2.gif "Свойства меры Internet Sales Reason Count")
...
13. На панели **иерархии** в конструкторе измерений создайте пользовательскую иерархию **Sales reasons** , которая содержит уровень `Sales Reason Type` и **причину покупки** в указанном порядке.

14. В окно свойств задайте в `All Sales Reasons` качестве значения свойства **AllMemberName** иерархии Sales reasons.

15. Определите в `All Sales Reasons` качестве значения свойства **AttributeAllMemberName** измерения «причина покупки».
...
18. В меню **File** (Файл) выберите команду **Save All** (Сохранить все).
...
6.  Разверните каждый элемент уровня, `Sales Reason Type` чтобы проверить значения в долларах, связанные с каждой из причин, по которым клиент в Квинсленд дал заявку на покупку [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] продукта через Интернет.
     ...
     ![Панели «Фильтр» и «Данные» конструктора кубов](../../2014/tutorials/media/l5-many-to-many-5.gif "Панели «Фильтр» и «Данные» конструктора кубов")
