...
|**SQL Server**|Использует специализированный механизм трассировки для [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] обнаружения изменений в базовых таблицах для объекта.|  
