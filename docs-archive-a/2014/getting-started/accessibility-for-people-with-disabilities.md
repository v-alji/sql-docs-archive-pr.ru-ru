...
### <a name="obtaining-documentation-for-ssnoversion"></a>Получение документации по [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 Документация по [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] доступна в Интернете. Дополнительные сведения см. в разделе [использование документации по продукту для SQL Server](../index.yml).  
...
## <a name="see-also"></a>См. также:  
 [Приступая к работе с документацией по продукту для SQL Server](../index.yml)   
