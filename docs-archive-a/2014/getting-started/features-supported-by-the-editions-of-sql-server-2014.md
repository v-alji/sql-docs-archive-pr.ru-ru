...
> 
> **Примечание.** Для функций, поддерживаемых выпусками Evaluation и Developer, см [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] . набор функций предприятия.  
 ...
 [Инструменты управления](#Mgmt_Tools)  
  
 [Управляемость RDBMS](#RDBMS_mgmt)  
  
 [Средства разработки](#Dev_tools)  
  
 [Возможность программирования](#Programmability)  
 ...
 [Дополнительные службы базы данных](#Add_DBServices)  
  
 [Другие компоненты](#Other_Components)  
  
##  <a name="cross-box-scale-limits"></a><a name="CrossBoxScale"></a>Ограничения масштабирования между рамками  
...
##  <a name="high-availability"></a><a name="High_availability"></a> Высокий уровень доступности  
...
|Smart Backup|Да|Да|Да|Нет||||  
 ...
 <sup>2</sup> Эта функция доступна только для 64-разрядной версии [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
  
##  <a name="scalability-and-performance"></a><a name="Scalability"></a>Масштабируемость и производительность  
...
|Отложенная устойчивость|Да|Да|Да|Да|Да|Да|Да|  
 ...
 <sup>1</sup> эта функция доступна только для 64-разрядных систем [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
  
##  <a name="security"></a><a name="Enterprise_security"></a> безопасность  
...
##  <a name="management-tools"></a><a name="Mgmt_Tools"></a>Средства управления  
...
|Расширение буферного пула<sup>2</sup>|Да|Да|Да|||||  
 ...
 <sup>2</sup> эта функция доступна только для 64-разрядных систем [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
  
##  <a name="development-tools"></a><a name="Dev_tools"></a>Средства разработки  
...
##  <a name="integration-services"></a><a name="SSIS"></a> Службы Integration Services  
...
###  <a name="integration-services---advanced-adapters"></a><a name="SSIS_AA"></a>Integration Services-расширенные адаптеры  
...
###  <a name="integration-services---advanced-transforms"></a><a name="SSIS_AT"></a>Integration Services-расширенные преобразования  
...
##  <a name="data-warehouse"></a><a name="Data_warehouse"></a>Хранилище данных  
...
###  <a name="bi-semantic-model-multidimensional"></a><a name="BISemModel_multi"></a>Семантическая модель бизнес-аналитики (многомерная)  
...
###  <a name="bi-semantic-model-tabular"></a><a name="BISemModel_tabular"></a>Семантическая модель бизнес-аналитики (табличная)  
...
###  <a name="powerpivot-for-sharepoint"></a><a name="PowerPivot"></a> PowerPivot для SharePoint  
...
###  <a name="data-mining"></a><a name="DataMining"></a>Интеллектуальный анализ данных  
...
###  <a name="reporting-services-features"></a><a name="Reporting_features"></a>Reporting Services функции  
...
|[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] <sup>2</sup>|Да|Да||||||  
 ...
 <sup>1</sup> Дополнительные сведения о поддерживаемых источниках данных в см [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] . в разделе [Data Sources Supported by Reporting Services &#40;SSRS&#41;](../reporting-services/create-deploy-and-manage-mobile-and-paginated-reports.md).  
...
|----------------------------------------------------------------------|---------------------------------------------------------------------------|  
|Корпорация|Выпуски Standard Edition, Business Intelligence и Enterprise Edition (локальные или удаленные)|  
...
##  <a name="business-intelligence-clients"></a><a name="BIClients"></a> Клиенты бизнес-аналитики  
...
##  <a name="spatial-and-location-services"></a><a name="Spatial"></a>Службы пространственного и расположения  
...
##  <a name="additional-database-services"></a><a name="Add_DBServices"></a>Дополнительные службы баз данных  
...
##  <a name="other-components"></a><a name="Other_Components"></a>Другие компоненты  
