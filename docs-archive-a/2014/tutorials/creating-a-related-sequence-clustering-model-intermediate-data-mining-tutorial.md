...
1.  В в [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] конструкторе интеллектуального анализа данных перейдите на вкладку **модели интеллектуального анализа** .  
...
1.  На вкладке **модель интеллектуального анализа данных** щелкните правой кнопкой мыши новую модель с именем `Sequence Clustering` и выберите команду **обработать модель**.  
