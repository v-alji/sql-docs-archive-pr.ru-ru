...
## <a name="returning-the-content-of-a-mining-model"></a>Возвращение содержимого модели интеллектуального анализа данных  
 ...
 Ниже приведен общий пример ВЫБОРки из \<model> . Инструкция CONTENT:  
...
2.  Скопируйте общий пример ВЫБОРки из \<model> . Инструкция CONTENT в пустой запрос.  
...
6.  В диалоговом окне **Сохранить как** перейдите в соответствующую папку и присвойте файлу имя `SELECT_CONTENT.dmx` .  
...
## <a name="use-drillthrough"></a>Использование детализации  
 ...
 Ниже приведен общий пример ВЫБОРки из \<model> . Оператор CASEs:  
...
2.  Скопируйте общий пример ВЫБОРки из \<model> . CASEs в пустой запрос.  
...
6.  В диалоговом окне **Сохранить как** перейдите в соответствующую папку и присвойте файлу имя `SELECT_DRILLTHROUGH.dmx` .  
...
6.  В диалоговом окне **Сохранить как** перейдите в соответствующую папку и присвойте файлу имя `SELECT_DISCRETE.dmx` .  
