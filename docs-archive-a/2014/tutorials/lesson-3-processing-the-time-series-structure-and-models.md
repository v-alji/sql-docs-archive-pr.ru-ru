...
5.  Вместо  
    ...
    ```  
     ...
     Исходный запрос ссылается на [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] источник данных, определенный в образце проекта интермедиатетуториал. Этот источник данных используется запросом для доступа к представлению vTimeSeries. Это представление содержит исходные данные, которые будут использованы для обучения модели интеллектуального анализа данных. Если вы не знакомы с этим проектом или представлениями, см. раздел[занятие 2. Создание сценария прогнозирования &#40;руководстве по интеллектуальному анализу данных&#41;](../../2014/tutorials/lesson-2-building-a-forecasting-scenario-intermediate-data-mining-tutorial.md).  
...
7.  В диалоговом окне **Сохранить как** перейдите в соответствующую папку и присвойте файлу имя `ProcessForecastingAll.dmx` .  
